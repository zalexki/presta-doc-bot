 ...
 */
final class Version20191009081244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE merge_commit (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, id_merge_commit VARCHAR(255) NOT NULL, author_name VARCHAR(255) NOT NULL, commit_message LONGTEXT NOT NULL, id_pull_request INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_949590B467B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
